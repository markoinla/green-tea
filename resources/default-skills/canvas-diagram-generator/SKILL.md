---
name: canvas-diagram-generator
description: 'Generate canvas diagrams from natural language descriptions. Use when asked to "create a diagram", "make a flowchart", "visualize a process", "draw a system architecture", "create a mind map", or "generate a canvas/Excalidraw file". Supports flowcharts, relationship diagrams, mind maps, and system architecture diagrams. Outputs .excalidraw JSON files that open directly in Green Tea''s built-in canvas viewer.'
---

# Canvas Diagram Generator

A skill for generating canvas diagrams (Excalidraw format) from natural language descriptions. This skill helps create visual representations of processes, systems, relationships, and ideas without manual drawing. Generated `.excalidraw` files open directly in Green Tea's built-in canvas viewer.
...
2. The file opens directly in Green Tea's built-in canvas viewer — no external tool needed.
...
3. 📝 Element count
4. 💡 Note that it opens in Green Tea's canvas viewer for editing
...
Open it in Green Tea's canvas viewer to view and edit.
```
...
3. **If library does NOT exist**: Respond with setup instructions:
   ...
   3. Create directory: skills/canvas-diagram-generator/libraries/[icon-set-name]/
   4. Place the downloaded file in that directory
   5. Run the splitter script:
      python skills/canvas-diagram-generator/scripts/split-excalidraw-library.py skills/canvas-diagram-generator/libraries/[icon-set-name]/
...
```bash
mkdir -p skills/canvas-diagram-generator/libraries/aws-architecture-icons
```
...
```bash
python skills/canvas-diagram-generator/scripts/split-excalidraw-library.py skills/canvas-diagram-generator/libraries/aws-architecture-icons/
```

**Step 5: Verify Setup**
After running the script, verify the following structure exists:
```
skills/canvas-diagram-generator/libraries/aws-architecture-icons/
...
2. **Add icons using Python script**:
   ```bash
   python skills/canvas-diagram-generator/scripts/add-icon-to-diagram.py \
...
3. **Add connecting arrows**:
   ```bash
   python skills/canvas-diagram-generator/scripts/add-arrow.py \
...
1. **Check for libraries**: 
   ```
   List directory: skills/canvas-diagram-generator/libraries/
